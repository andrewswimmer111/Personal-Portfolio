    ...
    return (
        <div className="intro-container">
            ...
            <div className="intro-text"> 
                <h1> Andrew Li </h1>
                <h3>
                    I’m a sophomore at Duke University majoring in computer science. 
                    ...
                    I love personal growth, so I’m always looking for opportunities to expand my skills and take on new challenges.
                </h3>
                <button className="intro-button"> Learn more about me and my projects! </button>
            </div>
        </div>
    )
}
